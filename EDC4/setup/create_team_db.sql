...
INSERT INTO CATALOG_NAME VALUES('1','USCG: Asset Manager DB','Database schema for the system that handles the assets.');
INSERT INTO CATALOG_NAME VALUES('2','USCG: GIS DB','Database schema for the system that handles the GIS data.');

CREATE TABLE CATALOG_TABLES (
 itemid VARCHAR(10) NOT NULL,
 name VARCHAR(30) NOT NULL,
 catalog_itemid_FK  VARCHAR(10) NOT NULL,
 primary key (itemid),
 FOREIGN KEY (catalog_itemid_FK)
);

INSERT INTO CATALOG_TABLES VALUES('1','AssetName_Table','1');
INSERT INTO CATALOG_TABLES VALUES('2','AssetLocation_Table','1');
INSERT INTO CATALOG_TABLES VALUES('3','AssetCost_Table','1');

INSERT INTO CATALOG_TABLES VALUES('1','GISName_Table','2');
INSERT INTO CATALOG_TABLES VALUES('2','GISLocation_Table','2');
INSERT INTO CATALOG_TABLES VALUES('3','GISCost_Table','2');
